...
public class ActivityAboutUs extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (JsonUtils.isNetworkAvailable(ActivityAboutUs.this)) {
            new getAboutUs(API.toBase64(jsObj.toString())).execute(Constant.API_URL);
        } else {
    ...
    private class getAboutUs extends AsyncTask<String, Void, String> {
        ...
        private getAboutUs(String base64) {
            this.base64 = base64;
        }
    ...
    private void setResult() {
        ...
        String text = "<html><head>"
                + "<style type=\"text/css\">@font-face {font-family: MyFont;src: url(\"file:///android_asset/fonts/Montserrat-Medium_0.otf\")}body{font-family: MyFont;color:"+color+";text-align:left}"
                + "</style></head>"
                + "<body>"
                + htmlText
                + "</body></html>";
